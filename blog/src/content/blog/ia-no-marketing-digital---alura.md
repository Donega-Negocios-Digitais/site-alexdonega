---
title: "IA no Marketing Digital - Alura"
...
tags:
  ...
  - "lgpd"
draft: true
author: "Aline Roque Klein"
tipo_nota: "artigo"
area: "[[Esforços/Áreas/Empresas/MyMess/MyMess.md|MyMess]]"
url_original: "https://www.alura.com.br/artigos/inteligencia-artificial-no-marketing-digital"
---
...
```mermaid
flowchart TD
    A[IA Marketing Digital] --> B[Ferramentas]
    A --> C[Aplicações]
    A --> D[Benefícios]
    A --> E[Desafios]
    ...
    B --> B2[ManyChat]
    B --> B3[ChatGPT/Jasper]
    B --> B4[Semrush/MarketMuse]
    B --> B5[Google Suite]

    C --> C1[Jornada Cliente]
    C --> C2[Qualificação Leads]
    C --> C3[Chatbots 24h]
    C --> C4[Mídia Paga]
