...
url_original: "https://www.anthropic.com/engineering/effective-context-engineering-for-ai-agents"
---

# [Effective Context Engineering for AI Agents - Anthropic](/blog/effective-context-engineering-for-ai-agents---anthropic)
...
> **🔗 Ler:** [Effective Context Engineering for AI Agents](https://www.anthropic.com/engineering/effective-context-engineering-for-ai-agents)
> **📰 Fonte:** [Anthropic](/blog/anthropic) (Oficial - Engineering Blog)
...
> - [Building Effective Agents](https://www.anthropic.com/research/building-effective-agents) - Guia fundacional sobre arquitetura de agentes
> - [Writing Tools for AI Agents – with AI Agents](https://www.anthropic.com/engineering/writing-tools-for-agents) - Design de ferramentas para agentes
> - [Multi-Agent Research System](https://www.anthropic.com/engineering/multi-agent-research-system) - Arquiteturas multi-agente
> - [Context Management Announcement](https://www.anthropic.com/news/context-management) - Memory tool e gerenciamento de contexto
>
> **Documentação Oficial**
> - [Anthropic Prompt Engineering Docs](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering/overview) - Documentação oficial de engenharia de prompts
> - [Model Context Protocol (MCP)](https://modelcontextprotocol.io/docs/getting-started/intro) - Protocolo de contexto de modelo
>
> **Pesquisa Acadêmica**
> - [Attention Is All You Need](https://arxiv.org/abs/1706.03762) - Paper original da arquitetura Transformer
> - [Position Encoding Interpolation](https://arxiv.org/pdf/2306.15595) - Extensão de janelas de contexto
> - [Context Rot Research](https://research.trychroma.com/context-rot) - Pesquisa sobre degradação de contexto
>
> **Ferramentas Mencionadas**
> - [Claude Code](https://www.anthropic.com/claude-code) - Solução de codificação com estratégia híbrida de contexto
> - [Memory and Context Cookbook](https://github.com/anthropics/claude-cookbooks/blob/main/tool_use/memory_cookbook.ipynb) - Exemplos práticos de gerenciamento de memória
> - [Claude Developer Console](https://console.anthropic.com/) - Plataforma de desenvolvimento com Memory Tool (beta)
>
> **Demonstração**
> - [Claude Plays Pokémon](https://www.twitch.tv/claudeplayspokemon) - Demonstração ao vivo de memória estruturada em agentes
...
|:-------------------|:--------------------|
| Foca em escrever e organizar instruções | Gerencia o **conjunto completo de tokens** |
| Para tarefas discretas (classificação, geração) | Para **operações contínuas de agentes** |
| Ênfase em system prompts | Inclui ferramentas, MCP, dados externos, histórico |
| Tarefa discreta | **Iterativo e contínuo** |
...
1. **Transformers:** cada token "participa da atenção" com cada outro token = n² relações
2. **Degradação:** menos experiência com dependências em contextos longos
3. **Treinamento:** sequências mais curtas são mais comuns nos dados
...
| Pré-Computada (tradicional) | Just-In-Time (emergente) |
|:----------------------------|:-------------------------|
| Recuperação baseada em embedding | Identificadores leves (paths, URLs, queries) |
| Mais rápida | Carrega dados dinamicamente em runtime |
| Pode ficar obsoleta | Espelha cognição humana |
...
| Técnica | Melhor para |
|:--------|:------------|
| **Compaction** | Tarefas com back-and-forth extenso |
| **Note-taking** | Desenvolvimento iterativo com milestones claros |
| **Multi-agent** | Pesquisa complexa, exploração paralela |
...
- [Claude Developer Console](https://console.anthropic.com/) - Plataforma de desenvolvimento com Memory Tool (beta público)
- [Claude.ai](https://claude.ai/) - Interface principal do Claude
- [Claude Code](https://www.anthropic.com/claude-code) - Ferramenta de codificação com estratégia híbrida de contexto

**Repositórios e Cookbooks:**
- [Memory and Context Management Cookbook](https://github.com/anthropics/claude-cookbooks/blob/main/tool_use/memory_cookbook.ipynb) - Exemplos práticos de implementação
- [Claude Cookbooks (Repositório)](https://github.com/anthropics/claude-cookbooks) - Coleção completa de exemplos

**Documentação:**
- [Prompt Engineering Docs](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering/overview) - Documentação oficial
- [Model Context Protocol (MCP)](https://modelcontextprotocol.io/docs/getting-started/intro) - Especificação do protocolo
