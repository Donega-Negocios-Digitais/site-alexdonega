...
# [Criando Templates Personalizados no Figma - BrandsDecoded](/blog/criando-templates-personalizados-no-figma---brandsdecoded)
...
> 🔗 **Link de Acesso**: [Acessar projeto Figma](https://www.figma.com/files/team/1093915952717711729/project/495564543/Content-Machine-3.0---BrandsDecoded?fuid=709503877771529172)  
> 📖 **Aula**: [Criando Templates Personalizados no Figma - BrandsDecoded](/blog/criando-templates-personalizados-no-figma---brandsdecoded)  
...
> 
> - Agente Content Machine 3.0 - [Acessar Agente](https://chatgpt.com/g/g-6884e69bc8408191922369dd40b39f9b-content-machinetm-3-0-brandsdecoded-r)
...
> - Projeto Figma - Content Machine 3.0 - [Acessar Projeto](https://www.figma.com/files/team/1093915952717711729/project/495564543/Content-Machine-3.0---BrandsDecoded?fuid=709503877771529172)
> - **Referências de Design no Behance:**
>     - [Social Media Tecnologia](https://www.behance.net/gallery/224313975/Social-Media-Tecnologia-Franquia)
>     - [Social Media Agro](https://www.behance.net/gallery/231733383/Social-Media-Agro)
>     - [Carrossel Igreja Metodista](https://www.behance.net/gallery/237277663/CARROSSEL-INSTAGRAM-A-ORIGEM-DA-IGREJA-METODISTA)
>     - [Criativos Carine Cechin](https://www.behance.net/gallery/207458945/Criativos-Carine-Cechin)
>     - [Design e Copy Mentora](https://www.behance.net/gallery/232866331/CARROSSEIS-\(DESIGN-E-COPY\)-PARA-MENTORA-DE-MULHERES)

> [!example]- Referências de Design de Carrosséis
> 
> ### 📱 **Instagram - Exemplos Reais**
> - [Carrossel 1](https://www.instagram.com/p/DQKoK6ggd5z/?hl=pt-br&img_index=9)
> - [Carrossel 2](https://www.instagram.com/p/DP7LaOhDTNS/?hl=pt-br&img_index=1)
> - [Carrossel 3](https://www.instagram.com/p/DPSZvxVj1rr/?hl=pt-br&img_index=1)
> - [Carrossel 4](https://www.instagram.com/p/DMqw7hAzjp_/?hl=pt-br&img_index=1)
> - [Carrossel 5](https://www.instagram.com/p/DMOTbSNvgjX/?hl=pt-br&img_index=1)
> 
> ### 🎨 **Behance - Portfolios Profissionais**
> - [Social Media Tecnologia - Franquia](https://www.behance.net/gallery/224313975/Social-Media-Tecnologia-Franquia?tracking_source=search_projects|carrossel+instagram&l=16)
> - [Social Media Agro](https://www.behance.net/gallery/231733383/Social-Media-Agro?tracking_source=search_projects|carrossel+instagram&l=31)
> - [Carrossel Instagram - A Origem da Igreja Metodista](https://www.behance.net/gallery/237277663/CARROSSEL-INSTAGRAM-A-ORIGEM-DA-IGREJA-METODISTA?tracking_source=search_projects|carrossel+instagram&l=122)
> - [Criativos Carine Cechin](https://www.behance.net/gallery/207458945/Criativos-Carine-Cechin?tracking_source=search_projects|carrossel+instagram&l=133)
> - [Carrosséis (Design e Copy) para Mentora de Mulheres](https://www.behance.net/gallery/232866331/CARROSSEIS-(DESIGN-E-COPY)-PARA-MENTORA-DE-MULHERES?tracking_source=search_projects|carrossel+instagram+copy&l=2)
> - [Projeto Carrossel - FalandoDeMercado](https://www.behance.net/gallery/138567233/Projeto-Carrossel-falandodemercado_?tracking_source=search_projects|carrossel+instagram+copy&l=208)
> - [Carrosséis para Instagram - Agência Austral](https://www.behance.net/gallery/238134917/Carrossis-para-Instagram-Agencia-Austral?tracking_source=search_projects|carrossel+instagram+copy&l=211)
> 
> ### 🖼️ **Canva - Templates de Referência**
> - [Template Canva](https://www.canva.com/templates/EAGr0Bbowuw/)
> 
...
1. Criar retângulo (`R`) ou usar frame existente
2. Copiar imagem da web
3. Selecionar o retângulo/frame
4. `Ctrl + V` para colar
...
2. Mudar para modo "Crop"
3. Reposicionar como preferir
4. Voltar para "Fill" se necessário
...
1. Selecionar o trecho desejado
2. Painel direito → Font weight
3. Escolher: Light / Regular / Bold / Black
...
1. Criar retângulo sobre a imagem (`R`)
2. Selecionar o retângulo
3. Painel direito → Fill
4. Mudar de "Solid" para "Linear Gradient"
5. Ajustar pontos do degradê:
...
1. Selecionar múltiplas camadas (Shift + Click)
2. Arrastar para selecionar
3. `Ctrl + R` para renomear
4. Digitar nome base (ex: "texto")
5. Figma adiciona automaticamente números sequenciais
...
1. Abrir painel de Layers (lado esquerdo)
2. Verificar se TODOS os blocos de texto estão nomeados:
...
1. Gerar conteúdo com número EXATO de blocos
2. Respeitar quantidade ESPECÍFICA de palavras em cada bloco
3. Expandir ideias se houver poucas palavras
4. Condensar conteúdo se houver muitas palavras
5. Manter 100% da ideia original
...
1. Ir ao ChatGPT
2. Criar novo Custom GPT
3. Colar o prompt na seção de instruções
4. Salvar e usar sempre que precisar daquele template

#### **Opção 2: Usar em Chat Normal**

Leonardo demonstra salvando o prompt em comentário no Figma:

1. Selecionar frame do template
2. Tecla `C` para criar comentário
3. Colar prompt completo
4. Sempre que precisar, copiar e usar
...
2. **Números faltando ou duplicados:**
...
1. Abrir painel Layers
2. Verificar nome de cada camada de texto
3. Comparar com conteúdo que você copiou
...
1. Copiar imagem
2. Selecionar frame no Figma
3. Colar (Ctrl+V)
4. Se não funcionar, deletar e tentar próxima
...
1. **Repetem em TODOS os slides:**
    
    - Rodapé com marca
    - Copyright
    - Elementos de identidade
2. **Têm alta probabilidade de mudança:**
    
    - Informações de contato
    - Ano de copyright
    - Nome da marca
3. **Economizam tempo significativo:**
...
1. **Aguardar 5-10 segundos antes de reaplicar**
2. **Fechar e reabrir o plugin**
3. **Recarregar o arquivo Figma (Ctrl+R)**
4. **Verificar se há muitos elementos selecionados**
5. **Simplificar estrutura de layers temporariamente**
...
1. [Social Media Tecnologia - Franquia](https://www.behance.net/gallery/224313975/Social-Media-Tecnologia-Franquia)
2. [Social Media Agro](https://www.behance.net/gallery/231733383/Social-Media-Agro)
3. [Carrossel Igreja Metodista](https://www.behance.net/gallery/237277663/CARROSSEL-INSTAGRAM-A-ORIGEM-DA-IGREJA-METODISTA)
4. [Criativos Carine Cechin](https://www.behance.net/gallery/207458945/Criativos-Carine-Cechin)
5. [Design e Copy para Mentora de Mulheres](https://www.behance.net/gallery/232866331/CARROSSEIS-\(DESIGN-E-COPY\)-PARA-MENTORA-DE-MULHERES)
