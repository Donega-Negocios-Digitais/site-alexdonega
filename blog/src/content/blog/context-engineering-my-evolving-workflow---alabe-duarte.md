...
url_original: "https://alabeduarte.com/context-engineering-with-claude-code-my-evolving-workflow/"
---

# [Context Engineering My Evolving Workflow - Alabe Duarte](/blog/context-engineering-my-evolving-workflow---alabe-duarte)
...
> **Ler:** [Context Engineering with Claude Code: My Evolving Workflow](https://alabeduarte.com/context-engineering-with-claude-code-my-evolving-workflow/)
> **Fonte:** [Alabe Duarte](/blog/alabe-duarte) (Blog Pessoal)
...
| Fase | Foco | Output |
|:-----|:-----|:-------|
| **1. Context Building** | Explicar código entendido para validação | Arquivos markdown documentando features |
| **2. Planning** | Explorar alternativas e desafiar sugestões | Plano documentado com reasoning |
| **3. Implementation** | Código preciso com referências | Código + commits |
...
**Processo:**
1. Explicar código que você entendeu (não pedir explicação)
2. Claude valida ou corrige entendimento
3. Resultado: arquivos markdown documentando features específicas
...
**Processo:**
1. Executar `/clear` para limpar contexto anterior
2. Carregar apenas informação relevante para planning
3. **Desafiar** sugestões do Claude
4. Explorar alternativas
5. Documentar reasoning antes de implementar
...
**Processo:**
1. Mais um `/clear` para focar em implementação
2. Usar Neovim com claudecode.nvim plugin
3. Seleção precisa de código como referência
4. **Testes primeiro** como checkpoints de especificação

### Delegação de Commit Messages

O autor delega escrita de commit messages para Claude Code:

| Autor faz | Claude Code faz |
|:----------|:----------------|
| Git workflow manual | Escreve commit messages comprehensive |
| Revisa mensagem | Descreve mudanças detalhadamente |
| Confirma commit | Mantém histórico rico |
...
- [Alabe Duarte - Context Engineering Workflow](https://alabeduarte.com/context-engineering-with-claude-code-my-evolving-workflow/)
- [claudecode.nvim](https://github.com/alabeduarte/claudecode.nvim)
