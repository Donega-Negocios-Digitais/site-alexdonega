---
name: guia-arquitetura-projeto
description: Cria documentação abrangente de arquitetura de projeto incluindo estrutura completa de pastas com responsabilidades, contratos por diretório, convenções de nomenclatura, fluxos de implementação e workflows visuais. Use ao documentar projetos existentes, estabelecer padrões arquiteturais, fazer onboarding de equipes ou planejar refatoração de codebase.
---
