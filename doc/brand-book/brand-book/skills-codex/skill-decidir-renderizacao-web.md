...
description: Decide entre SSG, SSR, híbrida, SPA e MPA com matriz de decisão, arvore de escolha e documentação de trade-offs. Use ao definir estratégia de renderizacao por rota, planejar migracoes ou justificar excecoes arquiteturais.
---
