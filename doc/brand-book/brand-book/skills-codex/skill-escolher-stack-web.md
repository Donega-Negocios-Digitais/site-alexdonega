...
description: Seleciona e documenta stack tecnológica web com critérios técnicos, trade-offs e regras de adocao. Use ao iniciar projeto, revisar stack atual, avaliar novas dependências ou padronizar decisões de arquitetura técnica.
---
