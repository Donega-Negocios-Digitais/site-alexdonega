---
title: "Agentes IA para Marketing Digital - Botpress"
...
tags:
  ...
  - "personalizacao"
draft: false
author: "Diane Clark-Lamey"
tipo_nota: "artigo"
area: "[[Esforços/Áreas/Empresas/MyMess/MyMess.md|MyMess]]"
url_original: "https://botpress.com/pt/blog/ai-agent-for-digital-marketing"
---
...
```mermaid
flowchart TD
    A[Agentes IA Marketing] --> B[Segmentação]
    A --> C[Automação]
    A --> D[Personalização]
    A --> E[Conversacional]

    B --> B1[Audiências em Tempo Real]
    B --> B2[Targeting Dinâmico]

    C --> C1[Campanhas Automatizadas]
    C --> C2[Ajuste de Budget]

    D --> D1[Emails Personalizados]
    D --> D2[Landing Pages]

    E --> E1[Chatbots 24/7]
    E --> E2[Qualificação de Leads]
